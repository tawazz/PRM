  ...
  <!-- Service Tabs -->
        <div class="row">
            <div class="col-lg-12" style="margin-top: 50px;">
                <h2 class="page-header">Ministries</h2>
            </div>
        </div>
              <!-- Portfolio Item Row -->
        <div class="row">
                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img class="img-responsive" src="/img/IMG_1985.JPG" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/img/IMG_1986.JPG" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="/img/IMG_1987.JPG" alt="">
                        </div>
                    </div>
